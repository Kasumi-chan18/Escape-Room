    ...
    public void interact(Player player) {
            ...
            switch (action) {
                case "investigate":
                    System.out.println("You walk around the room and see graves and tombstones with names on them. \n"
                            + "The names read: \n" + "Peter \n" + "Edmund \n" + "Lucy \n" + "Susan");
                    System.out.println(
                            "You look to your left and notice a ghastly, scary-looking white witch standing behind two giant switches, staring wickedly at you.");
                ...
                case "pull switch":
                    ...
                    if (correctSwitch) {
                        ...
                        hasEscaped = true;
                        player.increaseScore(ZombPoints);
                    } else {
        ...
        if (isChased) {
            ...
            System.out.println("The white witch has caught you." + "You have died."
                    + "Restart the game to escape the haunted mansion...");
            System.exit(0);
        }
    }
